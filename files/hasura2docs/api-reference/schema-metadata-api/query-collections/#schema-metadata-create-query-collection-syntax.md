...
- [ add_query_to_collection ](https://hasura.io/docs/latest/api-reference/schema-metadata-api/query-collections/#schema-metadata-create-query-collection-syntax/#schema-metadata-add-query-to-collection)
