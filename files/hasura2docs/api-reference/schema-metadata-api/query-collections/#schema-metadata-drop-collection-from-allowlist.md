...
- [ add_query_to_collection ](https://hasura.io/docs/latest/api-reference/schema-metadata-api/query-collections/#schema-metadata-drop-collection-from-allowlist/#schema-metadata-add-query-to-collection)
