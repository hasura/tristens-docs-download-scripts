...
- [ Introduction ](https://hasura.io/docs/latest/api-reference/schema-metadata-api/custom-types/#schema-metadata-set-custom-types/#introduction)
- [ set_custom_types ](https://hasura.io/docs/latest/api-reference/schema-metadata-api/custom-types/#schema-metadata-set-custom-types/#schema-metadata-set-custom-types)
    - [ Args syntax ](https://hasura.io/docs/latest/api-reference/schema-metadata-api/custom-types/#schema-metadata-set-custom-types/#schema-metadata-set-custom-types-syntax)
