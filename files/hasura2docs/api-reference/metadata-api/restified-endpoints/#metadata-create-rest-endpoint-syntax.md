...
- [ Introduction ](https://hasura.io/docs/latest/api-reference/metadata-api/restified-endpoints/#metadata-create-rest-endpoint-syntax/#introduction)
- [ create_rest_endpoint ](https://hasura.io/docs/latest/api-reference/metadata-api/restified-endpoints/#metadata-create-rest-endpoint-syntax/#metadata-create-rest-endpoint)
    - [ Args syntax ](https://hasura.io/docs/latest/api-reference/metadata-api/restified-endpoints/#metadata-create-rest-endpoint-syntax/#metadata-create-rest-endpoint-syntax)
- [ drop_rest_endpoint ](https://hasura.io/docs/latest/api-reference/metadata-api/restified-endpoints/#metadata-create-rest-endpoint-syntax/#metadata-drop-rest-endpoint)
    - [ Args syntax ](https://hasura.io/docs/latest/api-reference/metadata-api/restified-endpoints/#metadata-create-rest-endpoint-syntax/#metadata-drop-rest-endpoint-syntax)
