...
- [ Introduction ](https://hasura.io/docs/latest/api-reference/metadata-api/network/#drop-host-from-tls-allowlist-syntax/#introduction)
- [ TLS allow list ](https://hasura.io/docs/latest/api-reference/metadata-api/network/#drop-host-from-tls-allowlist-syntax/#tls-allow-list)
- [ add_host_to_tls_allowlist ](https://hasura.io/docs/latest/api-reference/metadata-api/network/#drop-host-from-tls-allowlist-syntax/#metadata-add-host-to-tls-allowlist)
    - [ Args syntax ](https://hasura.io/docs/latest/api-reference/metadata-api/network/#drop-host-from-tls-allowlist-syntax/#add-host-to-tls-allowlist-syntax)
- [ drop_host_from_tls_allowlist ](https://hasura.io/docs/latest/api-reference/metadata-api/network/#drop-host-from-tls-allowlist-syntax/#metadata-drop-host-from-tls-allowlist)
    - [ Args syntax ](https://hasura.io/docs/latest/api-reference/metadata-api/network/#drop-host-from-tls-allowlist-syntax/#drop-host-from-tls-allowlist-syntax)
