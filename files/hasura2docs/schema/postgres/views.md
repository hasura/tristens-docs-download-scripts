...
- [ What are views? ](https://hasura.io/docs/latest/schema/postgres/views/#what-are-views)
- [ Creating views ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views)
- [ Tracking views ](https://hasura.io/docs/latest/schema/postgres/views/#tracking-views)
- [ Use cases ](https://hasura.io/docs/latest/schema/postgres/views/#use-cases)
    - [ Example: Group by and then aggregate ](https://hasura.io/docs/latest/schema/postgres/views/#example-group-by-and-then-aggregate)

- [ Example: Hide certain fields of a table ](https://hasura.io/docs/latest/schema/postgres/views/#example-hide-certain-fields-of-a-table)
