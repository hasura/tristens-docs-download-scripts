...
your[ create view SQL statement ](https://www.postgresql.org/docs/current/static/sql-createview.html)to the `up.sql` file. Also, add an SQL statement to the `down.sql` file that reverts the previous statement.
...
You can add a view by using the[ run_sql ](https://hasura.io/docs/latest/api-reference/schema-api/run-sql/#schema-run-sql)schema API:
...
In order to generate create, update, and delete permissions for a view, it must be[ insertable ](https://www.postgresql.org/docs/current/sql-createview.html#SQL-CREATEVIEW-EXAMPLES). Otherwise, you'll
...
To track the view and expose it over the GraphQL API, make the following API call to the[ pg_track_table ](https://hasura.io/docs/latest/api-reference/metadata-api/table-view/#metadata-pg-track-table)Metadata API:
...
requires any user input, you should use[ custom SQL functions ](https://hasura.io/docs/latest/schema/postgres/custom-functions/)instead.
...
- [ What are views? ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views/#what-are-views)
- [ Creating views ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views/#pg-create-views)
- [ Tracking views ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views/#tracking-views)
- [ Use cases ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views/#use-cases)
    - [ Example: Group by and then aggregate ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views/#example-group-by-and-then-aggregate)

- [ Example: Hide certain fields of a table ](https://hasura.io/docs/latest/schema/postgres/views/#pg-create-views/#example-hide-certain-fields-of-a-table)
