...
- [ To track all tables and views present in the database ](https://hasura.io/docs/latest/schema/postgres/using-existing-database/#to-track-all-tables-and-views-present-in-the-database)
