...
- [ Introduction ](https://hasura.io/docs/latest/schema/postgres/data-validations/#pg-data-validations-pg-triggers/#introduction)
- [ Using Postgres check constraints ](https://hasura.io/docs/latest/schema/postgres/data-validations/#pg-data-validations-pg-triggers/#pg-data-validations-check-constraints)
- [ Using Postgres triggers ](https://hasura.io/docs/latest/schema/postgres/data-validations/#pg-data-validations-pg-triggers/#pg-data-validations-pg-triggers)
- [ Using Hasura permissions ](https://hasura.io/docs/latest/schema/postgres/data-validations/#pg-data-validations-pg-triggers/#using-hasura-permissions)
- [ Using Hasura Actions ](https://hasura.io/docs/latest/schema/postgres/data-validations/#pg-data-validations-pg-triggers/#using-hasura-actions)
