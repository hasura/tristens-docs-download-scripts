...
- [ Roles ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#roles)
    - [ The admin role ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#the-admin-role)

- [ Role-based schema publishing ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#role-based-schema-publishing)

- [ Create a new role ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#create-a-new-role)

- [ Delete a role ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#delete-a-role)

- [ Copy a role ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#copy-a-role)
- [ Session variables ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#session-variables)
- [ Model roles in Hasura ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#model-roles-in-hasura)
- [ Permission information availability ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#permission-information-availability)
    - [ Relationship information is available in the same database ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#relationship-information-is-available-in-the-same-database)

- [ Relationship information is not available in the same database ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#relationship-information-is-not-available-in-the-same-database)
- [ Type formats of session variables ](https://hasura.io/docs/latest/auth/authorization/roles-variables/#type-formats-of-session-variables)
