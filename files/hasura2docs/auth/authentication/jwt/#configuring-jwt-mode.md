...
of which is a JSON object. More info on running Hasura Engine with the flag or environment variable[ is here ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#running-with-jwt).
...
When your auth server generates the JWT, the custom claims in the JWT **must contain the following** in a custom `https://hasura.io/jwt/claims` [ namespace ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#claims-namespace):
...
- Hasura GraphQL Engine only has access to JWT claims in the `https://hasura.io/jwt/claims` or[ custom defined ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#claims-namespace)namespace.
...
string - in the[ key ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-json-key)field along with the[ type ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-json-type).
...
here ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#auth0-issues).
...
- [ Introduction ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#introduction)
- [ Configure Hasura JWT mode ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#configure-hasura-jwt-mode)
- [ Hasura JWT ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#hasura-jwt)
    - [ Example Decoded Payload ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#example-decoded-payload)

- [ Example Encoded JWT ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#example-encoded-jwt)

- [ Hasura JWT format ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#hasura-jwt-format)

- [ Hasura JWT Claim Description ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#hasura-jwt-claim-description)

- [ JWT Notes ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-notes)
- [ Hasura JWT configuration options ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#hasura-jwt-configuration-options)
    - [ type ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-json-type)

- [ key ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-json-key)

- [ jwk_url ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-json-jwk_url)

- [ claims_namespace ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#claims-namespace)

- [ claims_format ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#claims_format)

- [ audience ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#audience)

- [ issuer ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#issuer)

- [ claims_map ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#claims_map)

- [ allowed_skew ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#allowed_skew)

- [ header ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#header)
- [ Run Hasura GraphQL Engine in JWT mode ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#running-with-jwt)
    - [ Docker ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#docker)

- [ Hasura Cloud ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#hasura-cloud)
- [ Hasura JWT Config Examples ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#hasura-jwt-config-examples)
- [ Multiple JWT Secrets ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#multiple-jwt-secrets)
- [ Security considerations ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#security-considerations)
    - [ Setting audience check ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#setting-audience-check)
- [ JWT with the WebSocket protocol ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-with-the-websocket-protocol)
- [ Popular providers and known issues ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#popular-providers-and-known-issues)
    - [ Firebase ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#firebase)

- [ Auth0 ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#auth0-issues)

- [ Clerk ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#clerk)
- [ Generate a JWT Config for Auth0 or Firebase ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#generating-jwt-config)
- [ JWT Example Apps ](https://hasura.io/docs/latest/auth/authentication/jwt/#configuring-jwt-mode/#jwt-example-apps)
