...
of which is a JSON object. More info on running Hasura Engine with the flag or environment variable[ is here ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#running-with-jwt).
...
When your auth server generates the JWT, the custom claims in the JWT **must contain the following** in a custom `https://hasura.io/jwt/claims` [ namespace ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#claims-namespace):
...
- Hasura GraphQL Engine only has access to JWT claims in the `https://hasura.io/jwt/claims` or[ custom defined ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#claims-namespace)namespace.
...
string - in the[ key ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-json-key)field along with the[ type ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-json-type).
...
here ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#auth0-issues).
...
- [ Introduction ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#introduction)
- [ Configure Hasura JWT mode ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#configure-hasura-jwt-mode)
- [ Hasura JWT ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#hasura-jwt)
    - [ Example Decoded Payload ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#example-decoded-payload)

- [ Example Encoded JWT ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#example-encoded-jwt)

- [ Hasura JWT format ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#hasura-jwt-format)

- [ Hasura JWT Claim Description ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#hasura-jwt-claim-description)

- [ JWT Notes ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-notes)
- [ Hasura JWT configuration options ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#hasura-jwt-configuration-options)
    - [ type ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-json-type)

- [ key ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-json-key)

- [ jwk_url ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-json-jwk_url)

- [ claims_namespace ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#claims-namespace)

- [ claims_format ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#claims_format)

- [ audience ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#audience)

- [ issuer ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#issuer)

- [ claims_map ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#claims_map)

- [ allowed_skew ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#allowed_skew)

- [ header ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#header)
- [ Run Hasura GraphQL Engine in JWT mode ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#running-with-jwt)
    - [ Docker ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#docker)

- [ Hasura Cloud ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#hasura-cloud)
- [ Hasura JWT Config Examples ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#hasura-jwt-config-examples)
- [ Multiple JWT Secrets ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#multiple-jwt-secrets)
- [ Security considerations ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#security-considerations)
    - [ Setting audience check ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#setting-audience-check)
- [ JWT with the WebSocket protocol ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-with-the-websocket-protocol)
- [ Popular providers and known issues ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#popular-providers-and-known-issues)
    - [ Firebase ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#firebase)

- [ Auth0 ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#auth0-issues)

- [ Clerk ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#clerk)
- [ Generate a JWT Config for Auth0 or Firebase ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#generating-jwt-config)
- [ JWT Example Apps ](https://hasura.io/docs/latest/auth/authentication/jwt/#x-hasura-/#jwt-example-apps)
