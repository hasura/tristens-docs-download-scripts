...
of which is a JSON object. More info on running Hasura Engine with the flag or environment variable[ is here ](https://hasura.io/docs/latest/auth/authentication/jwt/#running-with-jwt).
...
When your auth server generates the JWT, the custom claims in the JWT **must contain the following** in a custom `https://hasura.io/jwt/claims` [ namespace ](https://hasura.io/docs/latest/auth/authentication/jwt/#claims-namespace):
...
- Hasura GraphQL Engine only has access to JWT claims in the `https://hasura.io/jwt/claims` or[ custom defined ](https://hasura.io/docs/latest/auth/authentication/jwt/#claims-namespace)namespace.
...
string - in the[ key ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-json-key)field along with the[ type ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-json-type).
...
2. first, try to parse `no-cache` , `no-store` or `must-revalidate` in a `Cache-Control` header.

3. second, try to parse an `max-age` or `s-maxage` directive in a `Cache-Control` header.

4. third, check if an `Expires` header is present (if `Cache-Control` is not present), and try to parse the value
as a timestamp.
...
2. first, try to parse an `max-age` or `s-maxage` directive in a `Cache-Control` header.

3. second, check if an `Expires` header is present (if `Cache-Control` is not present), and try to parse the value
as a timestamp.
...
here ](https://hasura.io/docs/latest/auth/authentication/jwt/#auth0-issues).
...
- [ Introduction ](https://hasura.io/docs/latest/auth/authentication/jwt/#introduction)
- [ Configure Hasura JWT mode ](https://hasura.io/docs/latest/auth/authentication/jwt/#configure-hasura-jwt-mode)
- [ Hasura JWT ](https://hasura.io/docs/latest/auth/authentication/jwt/#hasura-jwt)
    - [ Example Decoded Payload ](https://hasura.io/docs/latest/auth/authentication/jwt/#example-decoded-payload)

- [ Example Encoded JWT ](https://hasura.io/docs/latest/auth/authentication/jwt/#example-encoded-jwt)

- [ Hasura JWT format ](https://hasura.io/docs/latest/auth/authentication/jwt/#hasura-jwt-format)

- [ Hasura JWT Claim Description ](https://hasura.io/docs/latest/auth/authentication/jwt/#hasura-jwt-claim-description)

- [ JWT Notes ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-notes)
- [ Hasura JWT configuration options ](https://hasura.io/docs/latest/auth/authentication/jwt/#hasura-jwt-configuration-options)
    - [ type ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-json-type)

- [ key ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-json-key)

- [ jwk_url ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-json-jwk_url)

- [ claims_namespace ](https://hasura.io/docs/latest/auth/authentication/jwt/#claims-namespace)

- [ claims_format ](https://hasura.io/docs/latest/auth/authentication/jwt/#claims_format)

- [ audience ](https://hasura.io/docs/latest/auth/authentication/jwt/#audience)

- [ issuer ](https://hasura.io/docs/latest/auth/authentication/jwt/#issuer)

- [ claims_map ](https://hasura.io/docs/latest/auth/authentication/jwt/#claims_map)

- [ allowed_skew ](https://hasura.io/docs/latest/auth/authentication/jwt/#allowed_skew)

- [ header ](https://hasura.io/docs/latest/auth/authentication/jwt/#header)
- [ Run Hasura GraphQL Engine in JWT mode ](https://hasura.io/docs/latest/auth/authentication/jwt/#running-with-jwt)
    - [ Docker ](https://hasura.io/docs/latest/auth/authentication/jwt/#docker)

- [ Hasura Cloud ](https://hasura.io/docs/latest/auth/authentication/jwt/#hasura-cloud)
- [ Hasura JWT Config Examples ](https://hasura.io/docs/latest/auth/authentication/jwt/#hasura-jwt-config-examples)
- [ Multiple JWT Secrets ](https://hasura.io/docs/latest/auth/authentication/jwt/#multiple-jwt-secrets)
- [ Security considerations ](https://hasura.io/docs/latest/auth/authentication/jwt/#security-considerations)
    - [ Setting audience check ](https://hasura.io/docs/latest/auth/authentication/jwt/#setting-audience-check)
- [ JWT with the WebSocket protocol ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-with-the-websocket-protocol)
- [ Popular providers and known issues ](https://hasura.io/docs/latest/auth/authentication/jwt/#popular-providers-and-known-issues)
    - [ Firebase ](https://hasura.io/docs/latest/auth/authentication/jwt/#firebase)

- [ Auth0 ](https://hasura.io/docs/latest/auth/authentication/jwt/#auth0-issues)

- [ Clerk ](https://hasura.io/docs/latest/auth/authentication/jwt/#clerk)
- [ Generate a JWT Config for Auth0 or Firebase ](https://hasura.io/docs/latest/auth/authentication/jwt/#generating-jwt-config)
- [ JWT Example Apps ](https://hasura.io/docs/latest/auth/authentication/jwt/#jwt-example-apps)
