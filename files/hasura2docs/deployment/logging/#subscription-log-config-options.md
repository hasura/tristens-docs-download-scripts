...
See[ log-types ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#log-types)for more details on log-level of each log-type.
...
- [ Accessing logs ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#accessing-logs)
- [ Different log-types ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#log-types)
    - [ Configurable log-types ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#configurable-log-types)

- [ Internal log-types ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#internal-log-types)
- [ Logging levels ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#logging-levels)
- [ Log structure and metrics ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#log-structure-and-metrics)
    - [ query-log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#query-log-structure)

- [ execution-log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#execution-log-structure)

- [ http-log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#http-log-structure)

- [ websocket-log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#websocket-log-structure)

- [ health-check-log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#health-check-log-structure)

- [ event-trigger-process log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#event-trigger-process-log-structure)

- [ scheduled-trigger-process log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#scheduled-trigger-process-log-structure)

- [ cron-event-generator-process log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#cron-event-generator-process-log-structure)

- [ livequery-poller-log structure ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#livequery-poller-log)
- [ Monitoring frameworks ](https://hasura.io/docs/latest/deployment/logging/#subscription-log-config-options/#monitoring-frameworks)
