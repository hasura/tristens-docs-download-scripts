...
- [ Introduction ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#introduction)
- [ HTTP handler ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#http-handler)
- [ Returning a success response ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#returning-a-success-response)
- [ Returning an error response ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#returning-an-error-response)
- [ Example ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#example)
- [ Restrict access to your action handler ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#securing-action-handlers)
    - [ Adding an action secret ](https://hasura.io/docs/latest/actions/action-handlers/#verify-the-secret-in-your-action-handler/#adding-an-action-secret)
