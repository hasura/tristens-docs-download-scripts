...
- [ Introduction ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#introduction)
- [ Creating triggers ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#creating-triggers)
    - [ Parameters ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#parameters)
- [ Advanced Settings ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#advanced-settings)
    - [ Listen columns for update ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#listen-columns-for-update)

- [ Retry Logic ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#retry-logic)

- [ Headers ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic/#headers)
