...
- [ Introduction ](https://hasura.io/docs/latest/event-triggers/create-trigger/#introduction)
- [ Creating triggers ](https://hasura.io/docs/latest/event-triggers/create-trigger/#creating-triggers)
    - [ Parameters ](https://hasura.io/docs/latest/event-triggers/create-trigger/#parameters)
- [ Advanced Settings ](https://hasura.io/docs/latest/event-triggers/create-trigger/#advanced-settings)
    - [ Listen columns for update ](https://hasura.io/docs/latest/event-triggers/create-trigger/#listen-columns-for-update)

- [ Retry Logic ](https://hasura.io/docs/latest/event-triggers/create-trigger/#retry-logic)

- [ Headers ](https://hasura.io/docs/latest/event-triggers/create-trigger/#headers)
