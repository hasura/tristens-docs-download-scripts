...
Image: [ Auth0 Dashboard ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-dashboard.png)

Image: [ Auth0 Dashboard ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-dashboard.png)

After that, go to the `Applications` page and click the `+ Create Application` button.

Image: [ Auth0 Applications Page ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-applications-page.png)
...
Image: [ Auth0 Create Application ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-create-application.png)
...
Image: [ Auth0 API Page ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-api-page.png)
...
Image: [ Auth0 New API Page ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-new-api-page.png)
...
Image: [ Auth0 Rules ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-rules.png)
...
Image: [ Auth0 Create Custom Rule ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-create-custom-rule.png)
...
Image: [ Hasura Auth0 Users Sync ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-auth0-users-sync.png?refresh)
...
It's essential to secure your endpoint with an `admin secret` before going further. Check[ this guide ](https://hasura.io/docs/latest/graphql/cloud/projects/secure/#adding-an-admin-secret)to learn how to do
it.
...
Image: [ Hasura JWT Configurator ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-jwt-config.png)
...
You will set the value as an environment variable in your Hasura Project. To do so, go to the[ Hasura Dashboard ](https://cloud.hasura.io?skip_onboarding=true/)and then click the "Gear ⚙️" icon.

Image: [ Hasura Project Env Vars ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-project-env-vars.png)
...
Image: [ Hasura JWT Secret ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-jwt-secret.png)
...
Image: [ Hasura Create Table ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-create-table.png)
...
Image: [ Hasura Permissions ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-permissions.png)
...
Image: [ Hasura Users Table ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/Hasura-users.png)
...
Image: [ Auth0 Extensions ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-extensions.png)
...
Image: [ Auth0 Authentication API Debugger ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-authentication-api-debugger.png)
...
Image: [ Auth0 Set Audience ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-set-audience.png)
...
Image: [ Auth0 Application Settings Callback URLs ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-app-settings-callback-urls.png)
...
Image: [ Auth0 Test OAUTH2/OIDC LOGIN ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-test-login.png)
...
Image: [ Auth0 Access Token ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/auth0-access-token.png)
...
Image: [ Hasura GraphQL Request with Authorization Bearer Token Generated by Auth0 ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-auth-bearer-token.png)
...
Image: [ Hasura GraphQL Request without Authorization Bearer Token Generated by Auth0 ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/auth0/hasura-not-auth-bearer-token.png)
...
- CONTENTS
- [ What is Auth0 ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#whatisauth0)
- [ How to Integrate Auth0 with Hasura ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#howtointegrateauth0withhasura)
- [ Custom JWT Claims ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#customjwtclaims)
- [ Sync Users Between Auth0 and Hasura ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#syncusersbetweenauth0andhasura)
- [ Connect Hasura with Auth0 ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#connecthasurawithauth0)
- [ Test Database Syncing Rule ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#testdatabasesyncingrule)
- [ Test Auth0 Token ](https://hasura.io/learn/graphql/hasura-authentication/integrations/auth0/#testauth0token)
