...
2. Add a redirect url: `http://CASDOOR_HOSTNAME/login` Image: [ Casdoor Application Setting ](https://github.com/RanTao123/image/blob/main/Casdoor%20Application%20Setting.png?raw=true)
3. Copy the client ID, we will need it in the following steps.


Image: [ Casdoor Application Setting ](https://github.com/RanTao123/image/blob/main/Casdoor%20Application%20Setting.png?raw=true)
...
Image: [ Pic showing the users page ](https://github.com/RanTao123/image/blob/main/user.png?raw=true)
...
Image: [ Add Casdoor JWT URL to Hasura ](https://github.com/RanTao123/image/blob/main/MD$GWN%5BBET2O538TG~LNZIM.png?raw=true)

Image: [ Add Casdoor JWT URL to Hasura ](https://github.com/RanTao123/image/blob/main/MD$GWN%5BBET2O538TG~LNZIM.png?raw=true)

If you are runnning Hasura Cloud, you can configure Hasura on Env vars.

Image: [ Add Casdoor JWT URL to Hasura Cloud ](https://github.com/RanTao123/image/blob/main/Z3A1GD0Q_VHO4A%7BPVW37%5DY1.png)

Image: [ Add Casdoor JWT URL to Hasura Cloud ](https://github.com/RanTao123/image/blob/main/Z3A1GD0Q_VHO4A%7BPVW37%5DY1.png)

Click "HASURA_GRAPHQL_JWT_SECRET" and input

Image: [ Add Casdoor JWT URL to Hasura Cloud ](https://github.com/RanTao123/image/blob/main/U3%241Y3V6DKGYVPGLY_XDI%60E.png)
...
Change the client ID to the ID you copied before, and input the public certificate of Casdoor, which you can find in `http://CASDOOR_HOSTNAME/Certs` .

Then, input the username and password you created for Hasura earlier.

Click Sign in.

Image: [ Retrieve JWT Token ](https://github.com/RanTao123/image/blob/main/login.png?raw=true)

Image: [ Retrieve JWT Token ](https://github.com/RanTao123/image/blob/main/login.png?raw=true)

Go back to Casdoor/Token page

Image: [ Token Page ](https://github.com/RanTao123/image/blob/main/asd.png?raw=true)

Image: [ Token Page ](https://github.com/RanTao123/image/blob/main/asd.png?raw=true)

Find the username you entered before then click "Edit" and copy the token.

Image: [ Access Token ](https://github.com/RanTao123/image/blob/main/access.png?raw=true)
...
Image: [ Picture showing the access token from Keycloak being used in Hasura ](https://github.com/RanTao123/image/blob/main/hasura.png?raw=truehttps://github.com/RanTao123/image/blob/main/hasura.png?raw=true)
...
- CONTENTS
- [ What is Casdoor? ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#whatiscasdoor?)
- [ Deploy Casdoor ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#deploycasdoor)
- [ Configure Casdoor application ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#configurecasdoorapplication)
- [ Add organization in Casdoor ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#addorganizationincasdoor)
- [ Add user in Casdoor ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#adduserincasdoor)
- [ Create a Hasura instance ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#createahasurainstance)
- [ Configure Hasura with Casdoor ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#configurehasurawithcasdoor)
- [ Retrieve JWT Token ](https://hasura.io/learn/graphql/hasura-authentication/integrations/casdoor/#retrievejwttoken)
