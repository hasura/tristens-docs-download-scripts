...
Image: [ Firebase Console ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-dashboard.png)
...
Image: [ Firebase Project Dashboard ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-project-dashboard.png)
...
Image: [ Firebase Project Auth Page ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-project-auth-page.png)
...
Image: [ Firebase Email Password Settings ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-email-password.png)
...
Image: [ Firebase Project Settings ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-project-settings.png)

Image: [ Firebase Project Settings ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-project-settings.png)

Once you are on the "Project Settings" page, scroll to the bottom of the page and click on `</>` to create a web application.

Image: [ Firebase Create Web App ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-create-web-app.png)
...
Image: [ Firebase Register Web App ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-register-app.png)
...
Image: [ Firebase SDK ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/firebase-sdk.png)
...
Image: [ Hasura Create Table ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/hasura-create-table.png)
...
Image: [ Hasura Permissions ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/hasura-permissions.png)
...
Image: [ Hasura Generate JWT Config ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/hasura-jwt-config.png)
...
Image: [ Hasura Cloud Dashboard ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/hasura-cloud-dashboard.png)
...
Image: [ Hasura Add JWT ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/hasura-add-jwt.png)
...
Image: [ Register to Firebase to get a JWT ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/get-jwt-example.png)
...
Image: [ Use JWT on Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/firebase/hasura-jwt-example.png?dh)
...
- CONTENTS
- [ What is Firebase ](https://hasura.io/learn/graphql/hasura-authentication/integrations/firebase/#whatisfirebase)
- [ Configure Firebase ](https://hasura.io/learn/graphql/hasura-authentication/integrations/firebase/#configurefirebase)
- [ Create Hasura App ](https://hasura.io/learn/graphql/hasura-authentication/integrations/firebase/#createhasuraapp)
- [ JWT Config in Hasura ](https://hasura.io/learn/graphql/hasura-authentication/integrations/firebase/#jwtconfiginhasura)
- [ Firebase with Hasura JWT Testing ](https://hasura.io/learn/graphql/hasura-authentication/integrations/firebase/#firebasewithhasurajwttesting)
- [ Optional: Firebase Hosting ](https://hasura.io/learn/graphql/hasura-authentication/integrations/firebase/#optional:firebasehosting)
