...
Image: [ The Homepage of SuperTokens ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/supertokens-homepage.png)
...
Image: [ The SuperTokens Sign Up Page ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/supertokens-sign-up-page.png)
...
Image: [ Choose the Account Region of Your SuperTokens Account ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/supertokens-choose-region.png)

Image: [ Choose the Account Region of Your SuperTokens Account ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/supertokens-choose-region.png)

That takes you to the "Dashboard" page, where you can see your `connectionURI` and `API key` .

Image: [ The SuperTokens Development Environment ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/supertokens-dev-env.png)
...
Image: [ Get PostgreSQL database connection details in SuperTokens ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/supertokens-connect-to-database.png)
...
Image: [ Connect to a database in Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-connect-database.png)
...
Image: [ Connect to SuperTokens database from Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-database-connection-params.png)
...
Image: [ Track tables or views in Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-track-tables-views.png)

Image: [ Track tables or views in Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-track-tables-views.png)

Do the same for the "foreign-key relationships".

Image: [ Track relationships in Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-track-relationships.png)
...
Image: [ Hasura Permissions ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-create-user-role.png)
...
Image: [ ngrok Example ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/ngrok-screenshot.png)
...
Image: [ Hasura JWT Secret ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-jwt-secret.png)
...
Image: [ SuperTokens with Hasura integration ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/supertokens/hasura-bearer-token-example.png)
...
- [ https://github.com/offscriptio/hasura-supertokens ](https://github.com/offscriptio/hasura-supertokens)
...
- CONTENTS
- [ What is SuperTokens ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#whatissupertokens)
- [ Set up SuperTokens ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#setupsupertokens)
- [ Create Hasura App ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#createhasuraapp)
- [ Backend Auth API Implementation ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#backendauthapiimplementation)
- [ Expose the Auth API Publicly ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#exposetheauthapipublicly)
- [ Integrate SuperTokens with Hasura ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#integratesupertokenswithhasura)
- [ Test the SuperTokens + Hasura Integration ](https://hasura.io/learn/graphql/hasura-authentication/integrations/supertokens/#testthesupertokens+hasuraintegration)
