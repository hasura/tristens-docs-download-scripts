...
Image: [ AWS Cognito Configure Sign-In Experience ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/configure-signin-experience.png)
...
Image: [ AWS Cognito Configure Security Requirements ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/configure-security-requirements.png)
...
Image: [ AWS Cognito Configure Sign-Up Experience ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/configure-signup-experience.png)
...
Image: [ AWS Cognito Configure Message Delivery ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/configure-message-delivery.png)
...
Image: [ AWS Cognito Integrate App ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/integrate-app-part-1.png)
...
Image: [ AWS Cognito Integrate App ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/integrate-app-part-2.png)
...
Image: [ AWS Cognito Integrate App ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/integrate-app-part-3.png)
...
Image: [ AWS Cognito App Client Grant Types ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/grant-types.png)

Image: [ AWS Cognito App Client Grant Types ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/grant-types.png)

The app client should also have a sign-out URL. Enter a sign-out URL as shown in the image below.

Image: [ AWS Cognito App Client Sign Out URL ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/sign-out-url.png)
...
Image: [ Create new AWS Lambda Function ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/new-lambda-function.png)
...
Go to the user pool created in the first step ( *Amazon Cognito > User pools > your-user-pool* ), and find the “User pool
properties” tab.

Now you should see the “Lambda triggers” section. Click “Add Lambda trigger”.

Image: [ User Pool Properties - Lambda Triggers ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/user-pool-lambda-trigger.png)
...
Image: [ Configure Lambda Trigger in Amazon Cognito ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/cognito-lambda-trigger.png)
...
Image: [ Picture showing how to create a table in Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/create-hasura-table.png)
...
Image: [ Picture showing how to set permissions in Hasura ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/hasura-set-permissions.png)
...
Image: [ Hasura JWT Secret ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/hasura-jwt-secret.png)
...
Image: [ Export Lambda Function ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/export-function.png)
...
Image: [ sync-users Lambda Function ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/sync-users-folder.png)
...
Image: [ Upload Code on Lambda ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/upload-zip-lambda.png)

Image: [ Upload Code on Lambda ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/upload-zip-lambda.png)

The image below illustrates how the function folder structure should look:

Image: [ sync-users Lambda Function Folder Structure ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/sync-users-lambda-structure.png)
...
Image: [ Add Lambda Trigger in Amazon Cognito ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/post-auth-trigger.png)
...
Image: [ Cognito Hosted UI Login ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/test-integration-login.png)
...
Image: [ Amazon Cognito Sign In Callback ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/cognito-integration-callback.png)
...
Image: [ Hasura Cognito Integration ](https://graphql-engine-cdn.hasura.io/learn-hasura/assets/graphql-hasura-authentication/cognito/hasura-cognito-integration.png)
...
- CONTENTS
- [ What is Amazon Cognito? ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#whatisamazoncognito?)
- [ Set Up User Pools and Hosted Web UI ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#setupuserpoolsandhostedwebui)
- [ Add Custom Claims to the JWT With a Lambda Function ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#addcustomclaimstothejwtwithalambdafunction)
- [ Configure Cognito To Trigger the Lambda Function ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#configurecognitototriggerthelambdafunction)
- [ Create Hasura App ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#createhasuraapp)
- [ Configure Hasura to Use Cognito Keys ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#configurehasuratousecognitokeys)
- [ Sync Users Between Hasura and Cognito ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#syncusersbetweenhasuraandcognito)
- [ Test the Integration ](https://hasura.io/learn/graphql/hasura-authentication/integrations/cognito/#testtheintegration)
